...
public class Constants {
    ...
    public static TwoWheelConstants localizerConstants = new TwoWheelConstants()
            .forwardPodY(-5.5)
            .strafePodX(-1.9)
            .forwardTicksToInches(0.00216455733832)
            .strafeTicksToInches(0.00216455733832)
            .forwardEncoder_HardwareMapName("motor_lf")
            .forwardEncoder_HardwareMapName("motor_rb");
